...
<head>
    ...
    <title><fmt:message bundle="${i18n}" key="admin.account.create"/></title>
</head>
<body>
...
<div class="page-content">
    <div class="page-header">
        <h1><fmt:message bundle="${i18n}" key="admin.account.create"/></h1>
    </div>
    <form class="form-horizontal" action="<c:url value="/admin/account/create"/>" method="POST">
      ...
      <div class="form-group">
        <div class="col-xs-offset-2 col-xs-6">
          <button type="submit" class="btn btn-primary">
            ...
            <fmt:message bundle="${i18n}" key="button.create"/>
          </button>
